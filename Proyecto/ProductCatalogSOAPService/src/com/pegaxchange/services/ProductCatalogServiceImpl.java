...
public class ProductCatalogServiceImpl {
    ...
    //Método para buscar un producto meidnate su ID
    ...
    //Método para insertar un producto en el catalogo
    public void insertProduct(Product product) {
        productCatalog.add(product);
    }
    
    //Método para inicializar el catalogo con una serie de productos
